...
export interface AssessmentReport {
  ...
  // Candidate-facing narrative generated by a softened coach pass.
  // Surfaced on the results page via results-transformer. Absent on older reports
  // generated before the coach pass existed — transformer falls back gracefully.
