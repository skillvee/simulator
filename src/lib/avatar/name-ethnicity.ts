...
const ETHNICITY_MAP: Record<string, EthnicGroup> = {
  ...
  // Southeast Asian
  linh: "southeast-asian",
  nguyen: "southeast-asian",
  tran: "southeast-asian",
  pham: "southeast-asian",
  minh: "southeast-asian",
  duc: "southeast-asian",
  santos: "southeast-asian",
  reyes: "southeast-asian",
  cruz: "southeast-asian",
  budi: "southeast-asian",
  siti: "southeast-asian",
  hartono: "southeast-asian",
  putri: "southeast-asian",
  dewi: "southeast-asian",
  rizal: "southeast-asian",
  ramon: "southeast-asian",
  leilani: "southeast-asian",
  ...
  noor: "middle-eastern",
  sara_k: "middle-eastern",
  yasmin: "middle-eastern",
  omar: "middle-eastern",
  ali: "middle-eastern",
  karim: "middle-eastern",
  tariq: "middle-eastern",
  rami: "middle-eastern",
  hassan: "middle-eastern",
  rashid: "middle-eastern",
  abbasi: "middle-eastern",
  khoury: "middle-eastern",
  ibrahim: "middle-eastern",
  mansour: "middle-eastern",
  tehrani: "middle-eastern",
  farah: "middle-eastern",
  ahmed: "middle-eastern",
  mohammed: "middle-eastern",
  youssef: "middle-eastern",
  layla: "middle-eastern",
  maryam: "middle-eastern",
  amira: "middle-eastern",
};
...
export function inferDemographics(fullName: string): Demographics {
  ...
  const group: EthnicGroup =
    ETHNICITY_MAP[firstName] || ETHNICITY_MAP[lastName] || "mixed";
