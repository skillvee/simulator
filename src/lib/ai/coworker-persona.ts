 ...
 *
 * All text (role, status messages, canned response) is localized via the
 * `work.decorativeTeam.<id>` i18n namespace — not stored on this object.
 */
export const DECORATIVE_TEAM_MEMBERS: DecorativeTeamMember[] = [
  {
    ...
    statusSchedule: [
      { status: "in-meeting", startMinutes: 0 },
      { status: "online", startMinutes: 20 },
      { status: "away", startMinutes: 50 },
    ],
  },
  {
    id: "derek-washington",
    ...
    availability: "online",
    statusSchedule: [
      { status: "online", startMinutes: 0 },
      { status: "in-meeting", startMinutes: 30 },
      { status: "online", startMinutes: 45 },
    ],
  },
  {
    id: "priya-sharma",
    ...
    availability: "away",
    statusSchedule: [
      { status: "away", startMinutes: 0 },
      { status: "online", startMinutes: 10 },
      { status: "in-meeting", startMinutes: 35 },
      { status: "online", startMinutes: 50 },
    ],
  },
  {
    id: "marcus-lee",
    ...
    statusSchedule: [
      { status: "online", startMinutes: 0 },
      { status: "away", startMinutes: 15 },
      { status: "online", startMinutes: 25 },
    ],
  },
  {
    id: "sofia-andersson",
  ...
  },
  {
    ...
    statusSchedule: [
      { status: "online", startMinutes: 0 },
      { status: "away", startMinutes: 20 },
      { status: "online", startMinutes: 40 },
    ],
  },
  {
    id: "nina-volkov",
    ...
    statusSchedule: [
      { status: "online", startMinutes: 0 },
      { status: "in-meeting", startMinutes: 25 },
      { status: "online", startMinutes: 40 },
      { status: "away", startMinutes: 55 },
    ],
  },
  {
    id: "carlos-mendez",
